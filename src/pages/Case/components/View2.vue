...
onMounted(() => {
    swiperEl = document.querySelector('.case2-swiper')
})
    ...
    <div class="view">
        <div v-show=" props.dataSource.length > 0">
            ...
            <div class="swiper-view">
                <swiper-container class="case2-swiper swiper" slides-per-view="1" speed="500" css-mode="true" @slidechange="slideChange">
